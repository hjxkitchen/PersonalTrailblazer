...
export default function ProjectsSection() {
  ...
  const renderGroupSection = (groupName: string, projects: Project[]) => (
    ...
    <section className="mb-16">
      ...
      <div className="space-y-12">
        <div className="grid lg:grid-cols-2 gap-8">
          {renderGroupSection("Social Commerce (Global, HyperLocal)", projectGroups["Social Commerce (Global, HyperLocal)"])}
          {renderGroupSection("Social Communities & Governance (Global, HyperLocal)", projectGroups["Social Communities & Governance (Global, HyperLocal)"])}
        </div>

...
export default function ProjectsSection() {
  ...
  const renderSection = (groupName: string, projects: Project[]) => (
    <div>
  ...
  return (
    <section className="mb-16">
      ...
      <div className="space-y-12">
        {/* Side by side sections for Social Commerce and Social Communities */}
        <div className="grid md:grid-cols-2 gap-8">
          {renderSection("Social Commerce (Global, HyperLocal)", projectGroups["Social Commerce (Global, HyperLocal)"])}
          {renderSection("Social Communities & Governance (Global, HyperLocal)", projectGroups["Social Communities & Governance (Global, HyperLocal)"])}
        </div>

        {/* Other sections */}
        {Object.entries(projectGroups)
          .filter(([groupName]) => 
            groupName !== "Social Commerce (Global, HyperLocal)" && 
            groupName !== "Social Communities & Governance (Global, HyperLocal)"
          )
